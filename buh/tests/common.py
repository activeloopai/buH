...
def assert_version(required_version):
    ...
    assert version_compare(deeplake.__version__, required_version) >= 0, f"deeplake version {deeplake.__version__} is too old. Required version is {required_version}"
